         ...
         <div className="flex items-center justify-center min-h-[calc(100vh-100px)] p-6">
            <div className="glass-card p-10 w-full max-w-lg relative overflow-hidden">
               ...
               <form onSubmit={handleAuth} className="space-y-6">
                  <input type="email" placeholder="Username" value={email} onChange={e => setEmail(e.target.value)} className="w-full input-ghost" required />
                  <input type="password" placeholder="Password" value={password} onChange={e => setPassword(e.target.value)} className="w-full input-ghost" required />
